  ...
  const { click ,tclick , setclick} = useContext(PopUp);
    ...
    return(
      <div>
        ...
        >
          {(props.name === "loading")  ? (
          <div className=" relative container bg-white p-6 z-10 w-[90%] md:w-1/3 shadow-md  
          ...
          rounded-md mx-auto top-1/2 -translate-y-1/2">
            <div>
            <div className="absolute top-2 right-2 text-black/70 cursor-pointer rounded-full"
                  onClick={() => {
                  setclick([0, 0, 0, 0]);
              }}
              >
          ...
          :(
            <div className=" relative container bg-white p-2 w-fit shadow-md 
            rounded-md mx-auto top-1/2 -translate-y-1/2"
            >
              <div className="absolute top-2 right-2 text-black/70 cursor-pointer rounded-full"
                  onClick={() => {
