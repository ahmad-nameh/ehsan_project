...
export const AddStu = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${apiUrl}/addStudent`, formData, {
        headers: {
          Accept: "application/json",
        },
      });
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex max-h-[90vh] overflow-auto flex gap-10 flex-wrap bg-white pt-12 px-12 pb-6 text-[13px] justify-between addstu">
          <div className="basis-2/5">
            ...
            />
            <br />
            <label>تاريخ الانضمام إلى الثانوية</label>
            <br />
            <input
              type="date"
              name="join_date"
        ...
        <button onClick={(e) => handleSubmit} className="adding mx-auto">
          إضافة
        </button>
      </form>
