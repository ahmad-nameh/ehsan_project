                ...
                <div className="max-h-[90vh] overflow-auto bg-white pt-12 px-12 pb-6 text-[13px] addstu">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-between w-full flex-wrap gap-10" >
                            <input type="date" className="basis-2/5" name="date" required onChange={handleInputChange} />
                            <input type="text" className="basis-2/5" name="place" placeholder="مكانها" required onChange={handleInputChange} />
                        </div>
                        <label>وصف</label><br/>
                        <textarea name="description" className="w-full" placeholder="وصف...." onChange={handleInputChange}></textarea>
                        <label>صورة</label><br/>
