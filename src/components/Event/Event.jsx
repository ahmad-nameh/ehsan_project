    ...
    return(
        <div className="container">
          <div className="p=10">
            ...
            <button onClick={()=>setclick([0,0,0,0,0,0,0,1])} className="adding mr-auto">إضافة</button>
            {data[0]&&<div className="container  p-10 mx-9" style={{width: "calc(100% - 100px)",
            marginRight: "100px",
            marginTop: "20px",
            padding: "0 20px",
      }}>
      ...
      {data.map((item,index) => (
      <div className="header grid grid-cols-custom-8 items-center py-4" key={index}>
