...
const Login = () => {
  ...
  return (
    <div className="mainWrap">
      ...
      >
        {role&&<div className="formContainer">
          <div className="formWrapper">
            ...
            <div className="user-data flex flex-col gap-9 relative">
              ...
              {!loginMode && (
                ...
                >
                  ...
                  <TextField
                    ...
                    required
                  />
                  {role && <FormControl sx={{}} variant="outlined" size="small">
              ...
              {message && <span className="text-green-600 text-center">{message}</span>}
            </div>
          </div>
        </div>}
      </div>
